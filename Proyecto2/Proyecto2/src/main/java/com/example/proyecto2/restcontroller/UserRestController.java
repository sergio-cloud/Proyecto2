...
public class UserRestController<PerfilNotFoundException> {
	...
	//DEVUELVE LISTA DE TODOS LOS CONTACTOS A LOS CUALES LES DIO LIKE EL USER LOGEADO NINO
	@RequestMapping(
	...
	public void deletePerfil(@PathVariable String nickname) {
		PerfilService.delete(nickname);	
	}*/
}